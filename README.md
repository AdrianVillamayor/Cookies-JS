...
![Badge-glow](https://img.shields.io/badge/CookiesJS-v.1.7-blue?style=flat-square) ![jsDelivr hits (GitHub)](https://img.shields.io/jsdelivr/gh/hm/AdrianVillamayor/Cookies-JS?style=flat-square) ![GitHub repo size](https://img.shields.io/github/repo-size/AdrianVillamayor/Cookies-JS?style=flat-square)
...
```html
<script src="https://cdn.jsdelivr.net/gh/AdrianVillamayor/Cookies-JS@1.7/src/cookies.min.js"></script>
```
