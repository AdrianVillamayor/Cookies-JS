...
![Badge-glow](https://img.shields.io/badge/CookiesJS-v.1.9-blue?style=flat-square) ![jsDelivr hits (GitHub)](https://data.jsdelivr.com/v1/package/gh/AdrianVillamayor/Cookies-JS/badge)](https://www.jsdelivr.com/package/gh/AdrianVillamayor/Cookies-JS) ![GitHub repo size](https://img.shields.io/github/repo-size/AdrianVillamayor/Cookies-JS?style=flat-square)
...
```html
<script src="https://cdn.jsdelivr.net/gh/AdrianVillamayor/Cookies-JS@1.9/src/cookies.min.js" integrity="sha256-unKQ4CGSarNaE1ZBOLWLKNBiW7Xo5MPof4+N9h4NT2Q=" crossorigin="anonymous"></script>
```
